...
Modal lists and input dialogs should pass their owning pane item as `owner`; this presents them in the owner's surface while leaving application-level notifications and permanent panels in the primary window.
