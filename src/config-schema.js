    ...
    properties: {
      ...
      titleBar: {
        ...
        enum: [
          {
            value: "custom",
            description: "Frameless, with the title bar drawn by a package",
          },
          {
            value: "native",
            description: "The operating system's title bar",
          },
          {
            value: "hidden",
            description: "Frameless, with no title bar",
          },
        ],
        default: "custom",
      },
  ...
  editor: {
    ...
    properties: {
      ...
      fontFamily: {
        ...
        type: "string",
        default: "Fira Code, Menlo, DejaVu Sans Mono, Consolas, monospace",
      },
      fontSize: {
        title: "Font Size",
  ...
  git: {
    ...
    properties: {
      path: {
        title: "Git Path",
        description:
          "Absolute path to the `git` executable Lumine should run. Leave empty to use the `git` found on your PATH.",
        type: "string",
        default: "",
      },
      scanDepth: {
      ...
      watchDiscovery: {
        ...
        description:
          "Detect Git repositories created or removed below project roots, so initializing or deleting one reaches the tree view and the Git panel without a reload. Disable this on very large directory trees and use the repository update command instead.",
        type: "boolean",
        default: true,
      },
      watchDepth: {
