...
module.exports = class RipgrepFileCrawler {
  ...
  // Public: Lists the files under one or more directories.
  //
  // * `directoryPaths` an {Array} of absolute directory paths to crawl.
  ...
  //     and is treated as no restriction at all.
  //   * `ignoredNames` an {Array} of {String} globs to exclude.
