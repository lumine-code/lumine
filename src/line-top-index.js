...
const Iterator = require("./line-top-index-iterator");
const {
  add: addLogicalPositions,
  subtract: subtractLogicalPositions,
} = require("./logical-position-helpers");
...
class LineTopIndex {
  ...
  rotateNodeLeft(pivot) {
    ...
    pivot.distanceFromLeftAncestor = addLogicalPositions(
      root.distanceFromLeftAncestor,
      pivot.distanceFromLeftAncestor,
    );
  }
  ...
  rotateNodeRight(pivot) {
    ...
    root.distanceFromLeftAncestor = subtractLogicalPositions(
      root.distanceFromLeftAncestor,
      pivot.distanceFromLeftAncestor,
    );
  }
