...
- **file-icons.classes** (`^1.0.0`): consumed to show file-type icons next to entries.
- **file-icons.elements** (`^1.0.0`): consumed to show element-based file-type icons next to entries.
